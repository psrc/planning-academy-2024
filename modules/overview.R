  ...
  moduleServer(id, function(input, output, session){
    ...
    output$overview <- renderUI({
      tagList(
        ...
        fluidRow(column(4, div(a(class = "source_url left-panel-url", 
                 ...
                 column(4, div(a(class = "source_url left-panel-url", 
        ...
        fluidRow(column(4, strong(tags$div(class="quicklink_text","PSRC Data Portal"))),
                 column(4, strong(tags$div(class="quicklink_text","PSRC Transportation Visualization Tool")))),
